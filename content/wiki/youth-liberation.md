...
[*Codename: Kids Next Door*](https://en.wikipedia.org/wiki/Codename:_Kids_Next_Door)
from the early 2000s. The main characters' objectives are to fight
crimes against children, many of which are committed by grown-ups.
...
An example of when kids's liberation is needed: Look at kids who run
away from abusive homes with authoritarian parents/guardians. And the
police's role is to simply return them to their parents. Pursuit of
youth liberation could look like communal resources such as housing,
food, and "parental" care being offered communally, so that children
have the ability to leave abusive households if needed and also have the
ability to return or slowly reconnect as they think is best.
